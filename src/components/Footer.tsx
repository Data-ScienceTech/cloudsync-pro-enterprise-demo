      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-emerald-400 mb-4 max-w-md">
        ...
        <div className="border-t border-emerald-800 mt-8 pt-8 text-center text-emerald-400">
          <p>&copy; {currentYear} CloudSync Pro. {t('footer.rights')}</p>
          ...
          <p className="text-sm mt-1">
            ...
            <Link to="/privacy-policy" className="text-emerald-400 hover:text-emerald-300 transition-colors">
              privacy policy
            </Link>
            {' '}and{' '}
